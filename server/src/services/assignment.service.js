...
const createAssignment = async (assignmentBody) => {
	// Use videoId if present, otherwise fallback to video (the key sent)
	const videoId = assignmentBody.videoId || assignmentBody.video;
	...
	// Make sure to save the correct videoId field in the assignment
	assignmentBody.videoId = videoId;
